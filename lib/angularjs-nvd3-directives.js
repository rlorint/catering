...
( function() {'use strict';
  ...
  ] ).directive('nvd3DiscreteBarHorizontalChart', [
        function() {
            return {
                restrict : 'EA',
                scope : {
                    ...
                    scope.$watch('data', function(data) {
                        if (data) {
                            ...
                            nv.addGraph({
                                generate : function() {
                                    initializeMargin(scope, attrs);
                                    var chart = nv.models.discreteBarHorizontalChart().width(scope.width).height(scope.height).margin(scope.margin).x(attrs.x === undefined ? function(d) {
                                        return d[0];
                                    } : scope.x()).y(attrs.y === undefined ? function(d) {
                                        return d[1];
                                    ...
                                    .barColor(attrs.barColor === undefined ? nv.utils.defaultColor() : scope.barColor()) //by manu
                ...
                function($scope, $element, $attrs) {
                    ...
                    $scope.d3Call = function(data, chart) {
                        ...
                        if (!$attrs.id) {
                            ...
                            bandlineData = [$scope.bandlineProperties.min, $scope.bandlineProperties.twentyFithPercentile, $scope.bandlineProperties.median, $scope.bandlineProperties.seventyFithPercentile, $scope.bandlineProperties.max];
